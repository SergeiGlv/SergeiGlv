...
<b>Владение Web-средствами проектирования:</b> JAVA, Hibernate, Spring, HTML5, CSS3, Bootstrap, JS, jQuery, JSON, XML, AJAX, PHP 8, Laravel, MySQL, C# (ASP.NET), BrainyCP (для продажи разработанных мною программ мною был создан «Интернет-магазин» (админ-панель, пользовательская часть, личный кабинет, каталог заказов, фильтрация, поиск, высылка сформированных заказов на email - автоматически на PHP, JS, jQuery, MySQL, HTML5, CSS3, в модели MVC был разработан собственный Framework). Несколько реализованных и внедренных проектов на JAVA+Maximo+Oracle.
### 💻 Технологии:
