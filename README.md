...
<b>Владение Web-средствами проектирования:</b> HTML5, CSS3, JS, jQuery, JSON, XML, AJAX, PHP 8, MySQL, BrainyCP (для продажи разработанных мною программ мною был создан «Интернет-магазин» (админ-панель, пользовательская часть, личный кабинет, каталог заказов, фильтрация, поиск, высылка сформированных заказов на email - автоматически на PHP, JS, jQuery, MySQL, HTML5, CSS3, в модели MVC был разработан собственный Framework).
### 💻 Технологии:
